...
import br.com.fiap.velha.gui.VelhaGUI;

public class JogoDaVelhaClient implements VelhaListener {
	...
	private VelhaGUI     velhaGUI     = null;
	...
	public JogoDaVelhaClient() {
		...
		velhaGUI       = new VelhaGUI(velhaEngine, this);
	}
